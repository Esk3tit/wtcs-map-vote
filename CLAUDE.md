...
- [Concepts](CONCEPTS.md) - shared domain vocabulary (entities, named processes, status concepts) with project-specific meaning; relevant when orienting to the codebase or discussing domain concepts
