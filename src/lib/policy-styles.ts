/** Shared Tailwind prose styles for policy pages (privacy, terms) */
export const policyContentStyles = `policy-content [&_h1]:text-3xl [&_h1]:font-bold [&_h1]:tracking-tight [&_h1]:text-foreground [&_h1]:mb-2
