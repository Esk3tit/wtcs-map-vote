...
**Impact:** Current indexes work but require fetching all session records then sorting client-side, which degrades as data grows; composite index enables single-pass filtered + ordered queries
